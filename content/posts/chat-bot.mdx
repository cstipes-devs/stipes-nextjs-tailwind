...
---
title: "Fighting AI with AI: Building a Resume Chatbot"
description: "Wrapping OpenAI's Responses API in a tiny Go service and a Next.js UI so recruiters can interrogate my resume conversationally."
